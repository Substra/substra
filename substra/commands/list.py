...
from .api import Api, ALGO_ASSET, CHALLENGE_ASSET, DATA_MANAGER_ASSET, MODEL_ASSET, TRAINTUPLE_ASSET, TESTTUPLE_ASSET, \
...
class List(Api):
    ...
    ACCEPTED_ASSETS = [ALGO_ASSET, CHALLENGE_ASSET, DATA_MANAGER_ASSET, MODEL_ASSET, TESTTUPLE_ASSET, TRAINTUPLE_ASSET]
