...
Usage:
  ...
  substra run_local <algo-path> --train-opener=<train_opener_path> --test-opener=<test_opener_path> --metrics=<metrics_path> [--rank=<rank>] --train-data-sample=<train_data_sample_path> --test-data-sample=<test_data_sample_path> [--inmodel=<inmodel_path>...] --outmodels=<outmodels_path>
  substra -h | --help
  substra --version
