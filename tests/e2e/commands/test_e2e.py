    ...
    def test_add_fixtures(self):
        ...
        self.assertTrue(
            json.loads(res) == {
                ...
                "name": "ISIC 2018",
                "data_opener": "%s/media/data_managers/ccbaa3372bc74bce39ce3b138f558b3a7558958ef2f244576e18ed75b0cea994/opener.py" % url,
                "description": "%s/media/data_managers/ccbaa3372bc74bce39ce3b138f558b3a7558958ef2f244576e18ed75b0cea994/description.md" % url,
                "validated": True
            })
        ...
        self.assertTrue(
            json.loads(res) == {
                ...
                "name": "Simplified ISIC 2018",
                "data_opener": "%s/media/data_managers/b4d2deeb9a59944d608e612abc8595c49186fa24075c4eb6f5e6050e4f9affa0/opener.py" % url,
                "description": "%s/media/data_managers/b4d2deeb9a59944d608e612abc8595c49186fa24075c4eb6f5e6050e4f9affa0/description.md" % url,
                "validated": True
            })
