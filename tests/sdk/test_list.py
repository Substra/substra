...
from substra.sdk.utils import flatten
...
class TestList(TestBase):
    ...
    @mock.patch('substra.sdk.rest_client.requests.get', side_effect=mocked_requests_list_objective_fail)
    ...
    @mock.patch('substra.sdk.rest_client.requests.get', side_effect=mocked_requests_get_data_manager)
    ...
    @mock.patch('substra.sdk.rest_client.requests.get', side_effect=mocked_requests_get_data_manager_no_json)
    ...
    @mock.patch('substra.sdk.rest_client.requests.get', side_effect=mocked_requests_get_objective_filtered)
