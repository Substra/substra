...
class TestAdd(TestBase):
    ...
    @mock.patch('substra.sdk.rest_client.requests.post', side_effect=mocked_requests_post_data_manager)
    ...
    @mock.patch('substra.sdk.rest_client.requests.post', side_effect=mocked_requests_post_objective)
    ...
    @mock.patch('substra.sdk.rest_client.requests.post', side_effect=mocked_requests_post_algo)
    ...
    @mock.patch('substra.sdk.rest_client.requests.post', side_effect=mocked_requests_add_objective_fail)
