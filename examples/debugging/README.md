...
- [Debugging](#debugging)
  ...
  - [Logs and breakpoints](#logs-and-breakpoints)
...
For more advanced debugging, it is possible to put a breakpoint in the `algo.py` file or any file loaded at runtime.

**WARNING**
The corresponding asset must be added locally for this to work !

To do this, add a breakpoint with pdb in the function:
