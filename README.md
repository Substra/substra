...
| [`X.X.X`](https://github.com/SubstraFoundation/substra/releases/tag/X.X.X) | [`0.0.11`](https://github.com/SubstraFoundation/substra-chaincode/releases/tag/0.0.11) | [`X.X.X`](https://github.com/SubstraFoundation/substra-backend/releases/tag/X.X.X) <br>[`helm chart X.X.X`](https://hub.helm.sh/charts/substra/substra-backend/X.X.X) | [`X.X.X`](https://github.com/SubstraFoundation/substra-tests/releases/tag/X.X.X) | [`0.0.13`](https://github.com/SubstraFoundation/hlf-k8s/releases/tag/0.0.13) <br>[`helm chart 3.0.1`](https://hub.helm.sh/charts/substra/hlf-k8s/3.0.1) | [`0.0.19`](https://github.com/SubstraFoundation/substra-frontend/releases/tag/0.0.19) <br>[`helm chart 1.0.0-alpha.2`](https://hub.helm.sh/charts/substra/substra-frontend/1.0.0-alpha.2) | [`X.X.X`](https://github.com/SubstraFoundation/substra-tools/releases/tag/X.X.X) |
